...
const Menu = (props) => {
    ...
    if (!user) {
        ...
        return (
            <nav className='d-flex flex-column flex-shrink-0 border p-0 bg-white bg-gradient' style={{height:'100vh'}}>
                <Link to="/">
                ...
                <ul className='nav nav-pills d-flex flex-column mb-auto p-0'>
                    ...
                    <li className='nav-item'>
                        <a href='#' className='text-dark nav-link' onClick={props.openModalCommunity}>コミュニティをつくる</a>
                    </li>
                </ul>
                <div className='border-top pt-2 nav-item d-flex align-items-center justify-content-center mb-1'>
                    <img className='rounded-circle' src={`${process.env.PUBLIC_URL}/img/001.png`} height={50} width={50}/>
